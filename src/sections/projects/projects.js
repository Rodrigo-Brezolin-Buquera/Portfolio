...
export const projectsList = [
  ...
  },
  {
    ...
    description: "Versão mobile do sistema de estudantes web em estágio inicial de desenvolvimento. Irá permitir permite mesmas funcionalidades da versão web tanto para alunos, quanto para os administradoresso sistema. ",
